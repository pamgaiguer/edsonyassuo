                ...
                <div class="work-page">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <h1 class="title-red">Vicentinos</h1>
                            <hr>
                            <p>Desenho animado com os personagens do colégio Vicentinos. A Turma Click se comunica com as crianças passando lições de cidadania, responsabilidade ambiental e apresenta diversas áreas do conhecimento.</p>
                            <ul class="list-unstyled">
                            ...
                            <div class="still-gallery">
                                <img src="images/vicentinos/vicentinos_still_01.jpg" alt="">
                                <img src="images/vicentinos/vicentinos_still_02.jpg" alt="">
                                <img src="images/vicentinos/vicentinos_still_03.jpg" alt="">
                                <img src="images/vicentinos/vicentinos_still_04.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
